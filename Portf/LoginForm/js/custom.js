...
$('.u_name').mousedown(function(){
    if($('.u_name input').val().length == ""){
        ...
        $('.u_name').css("border", "2px solid orange");
    ...
    $('.u_email').mousedown(function(){
        if($('.u_email input').val().length == ""){
            ...
            $('.u_email').css("border", "2px solid orange");
        ...
        $('.u_pass1').mousedown(function(){
            if($('.u_pass1 input').val().length == ""){
                ...
                $('.u_pass1').css("border", "2px solid orange");
            ...
            $('.u_pass2').mousedown(function(){
                if($('.u_pass2 input').val().length == ""){
                    ...
                    $('.u_pass2').css("border", "2px solid orange");
                ...
                $('.u_phone').mousedown(function(){
                    if($('.u_phone input').val().length == ""){
                        ...
                        $('.u_phone').css("border", "2px solid orange");
                    ...
                    $('.u_gen').keydown(function(){
                        if($('.u_gen select').val().length == ""){
                            ...
                            $('.u_gen').css("border", "2px solid orange");
                        ...
                        $('.u_dob').keydown(function(){
                            if($('.u_dob input').val().length == ""){
                                ...
                                $('.u_dob').css("border", "2px solid orange");
                            ...
                            $('.u_country').keydown(function(){
                                if($('.u_country select').val().length == ""){
                                    $('.u_country').css("border", "2px solid red");
                                    ...
                                    $('.u_country').css("border", "2px solid orange");
